...
export const supportedRoutes = buildSupportedRoutes(
  [
    ...
    defineRoute(
      [
        [KnownChainId.Bitcoin.Testnet, KnownChainId.EVM.BSCTest],
        [KnownChainId.Bitcoin.Testnet, KnownChainId.EVM.CoreDAOTest],
        [KnownChainId.Bitcoin.Testnet, KnownChainId.EVM.BsquaredTest],
        [KnownChainId.Bitcoin.Testnet, KnownChainId.EVM.BOBTest],
        [KnownChainId.Bitcoin.Testnet, KnownChainId.EVM.BitlayerTest],
        [KnownChainId.Bitcoin.Testnet, KnownChainId.EVM.LorenzoTest],
        [KnownChainId.Bitcoin.Testnet, KnownChainId.EVM.MerlinTest],
      ],
      [],
    ),
  ],
